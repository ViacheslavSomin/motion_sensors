...
class MotionSensorsPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    companion object {
        const val METHOD_CHANNEL_NAME = "motion_sensors/method"
        const val ACCELEROMETER_CHANNEL_NAME = "motion_sensors/accelerometer"
        const val GYROSCOPE_CHANNEL_NAME = "motion_sensors/gyroscope"
        const val MAGNETOMETER_CHANNEL_NAME = "motion_sensors/magnetometer"
        const val USER_ACCELEROMETER_CHANNEL_NAME = "motion_sensors/user_accelerometer"
        const val ORIENTATION_CHANNEL_NAME = "motion_sensors/orientation"
        const val ABSOLUTE_ORIENTATION_CHANNEL_NAME = "motion_sensors/absolute_orientation"
        const val SCREEN_ORIENTATION_CHANNEL_NAME = "motion_sensors/screen_orientation"
    }
    ...
    private fun setupEventChannels(context: Context, messenger: BinaryMessenger) {
        ...
        screenOrientationStreamHandler =
            ScreenOrientationStreamHandler(context, sensorManager!!, Sensor.TYPE_ACCELEROMETER)
